...
export const enumasyncChatNotificationsConstraint = {
  async_chat_notifications_pkey: 'async_chat_notifications_pkey',
}

export const enumasyncChatNotificationsSelectColumn = {
...
export const enumasyncChatNotificationsUpdateColumn = {
  created_at: 'created_at',
  deleted_at: 'deleted_at',
  id: 'id',
  message: 'message',
...
export const enumasyncChatTicketsConstraint = {
  async_chat_tickets_pkey: 'async_chat_tickets_pkey',
}

export const enumasyncChatTicketsSelectColumn = {
  created_at: 'created_at',
  id: 'id',
  title: 'title',
}

export const enumasyncChatTicketsUpdateColumn = {
  created_at: 'created_at',
  id: 'id',
  title: 'title',
}
