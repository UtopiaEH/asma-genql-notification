...
export const enumtriggersEnumsConstraint = {
  triggers_enums_pkey: 'triggers_enums_pkey',
}

export const enumtriggersEnumsEnum = {
  create_ticket: 'create_ticket',
  insert_ticket_user: 'insert_ticket_user',
}

export const enumtriggersEnumsSelectColumn = {
  description: 'description',
  trigger: 'trigger',
}

export const enumtriggersEnumsUpdateColumn = {
  description: 'description',
  trigger: 'trigger',
}
