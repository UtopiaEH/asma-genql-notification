...
var ticket_service_possibleTypes = ['ticket_service']
export var isticket_service = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "isticket_service"')
  return ticket_service_possibleTypes.includes(obj.__typename)
}



var ticket_service_aggregate_possibleTypes = ['ticket_service_aggregate']
export var isticket_service_aggregate = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "isticket_service_aggregate"')
  return ticket_service_aggregate_possibleTypes.includes(obj.__typename)
}



var ticket_service_aggregate_fields_possibleTypes = ['ticket_service_aggregate_fields']
export var isticket_service_aggregate_fields = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "isticket_service_aggregate_fields"')
  return ticket_service_aggregate_fields_possibleTypes.includes(obj.__typename)
}



var ticket_service_max_fields_possibleTypes = ['ticket_service_max_fields']
export var isticket_service_max_fields = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "isticket_service_max_fields"')
  return ticket_service_max_fields_possibleTypes.includes(obj.__typename)
}



var ticket_service_min_fields_possibleTypes = ['ticket_service_min_fields']
export var isticket_service_min_fields = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "isticket_service_min_fields"')
  return ticket_service_min_fields_possibleTypes.includes(obj.__typename)
}



var ticket_service_mutation_response_possibleTypes = ['ticket_service_mutation_response']
export var isticket_service_mutation_response = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "isticket_service_mutation_response"')
