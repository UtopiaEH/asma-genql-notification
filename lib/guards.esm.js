...
var subject_service_possibleTypes = ['subject_service']
export var issubject_service = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "issubject_service"')
  return subject_service_possibleTypes.includes(obj.__typename)
}



var subject_service_aggregate_possibleTypes = ['subject_service_aggregate']
export var issubject_service_aggregate = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "issubject_service_aggregate"')
  return subject_service_aggregate_possibleTypes.includes(obj.__typename)
}



var subject_service_aggregate_fields_possibleTypes = ['subject_service_aggregate_fields']
export var issubject_service_aggregate_fields = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "issubject_service_aggregate_fields"')
  return subject_service_aggregate_fields_possibleTypes.includes(obj.__typename)
}



var subject_service_max_fields_possibleTypes = ['subject_service_max_fields']
export var issubject_service_max_fields = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "issubject_service_max_fields"')
  return subject_service_max_fields_possibleTypes.includes(obj.__typename)
}



var subject_service_min_fields_possibleTypes = ['subject_service_min_fields']
export var issubject_service_min_fields = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "issubject_service_min_fields"')
  return subject_service_min_fields_possibleTypes.includes(obj.__typename)
}



var subject_service_mutation_response_possibleTypes = ['subject_service_mutation_response']
export var issubject_service_mutation_response = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "issubject_service_mutation_response"')
...
export var isusers = function(obj) {
